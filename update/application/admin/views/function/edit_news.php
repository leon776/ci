...
<form id="rec_form" class="form-horizontal" action="<?php echo base_url();?>index.php/news/update" method="post">
  ...
  <label class="control-label" for="thumb">新闻封面(480x320)</label>
  <div class="controls">
