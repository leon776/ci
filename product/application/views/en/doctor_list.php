     ...
     <div class="container">
     	<div class="select-header">
            ...
            <div class="select-department select-collapse collapse">
                ...
                <li class=""><a href="index.php/doctor/index/0/<?php echo $city;?>/全部">All Department</a></li>
                 <?php
         ...
         <div class="select-header">
            ...
            <div class="select-city select-collapse collapse">
                <ul class="nav navbar-nav">
                <li class=""><a href="index.php/doctor/index/0/全部/<?php echo $depart;?>/">All city</a></li>
                <?php
        ...
        <div class="row grid cs-style-3"> <!-- 上传图片大小：360*450px -->
            ...
            <div class='col co-xs-6 col-sm-6 col-md-9'>
                <div class="txt">
                    ...
                    <p class="intro">Department：<?php echo $value['department']?></p> 
					<p class="contact">
                        Tel： <?php echo $value['tel']?> <br>
                        Addr： <?php echo $value['addr']?><br>
                        Charge： $<?php echo $value['charge']?>起<br>
                        Hospital： <?php echo $value['hospital']?>
                    </p>
                    <div class="more">
