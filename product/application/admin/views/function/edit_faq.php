...
<form id="rec_form" class="form-horizontal" action="<?php echo base_url();?>index.php/faq/update" method="post">
   ...
   <div class="control-group" id="aboutSearchBox">
    ...
    <div class="controls">
     <input id="title" name="title" type="title" class="input" value="<?php
      echo $title;
     ?>" required="" onkeyup="" autocomplete="off" />
    </div>
   </div>
  <div class="control-group" id="aboutSearchBox">
    <label class="control-label" for="name">位置</label>
    <div class="controls">
     <input id="place" name="place" type="title" class="number" value="<?php
      echo $place;
     ?>" required="" onkeyup="" autocomplete="off" />
    </div>
   </div>
   <div class="control-group" id="aboutSearchBox">
    ...
    <div class="controls">
     <textarea id="content" name="content" rows="10" autocomplete="off"><?php
      echo $content;
     ?></textarea>
    </div>
   </div>
