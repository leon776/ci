...
<div class="office-address">
     <div class="image"><img src="assets/images/office.jpg" alt="Shenzhen gray medical company"></div>
     <div class="content">
         <h3>Shenzhen gray medical company</h3>
...
<script type="text/javascript">
    ...
    //标注点数组
    var markerArr = [{title:"Shenzhen gray medical company",content:"Shenzhen shennan avenue diwang<br/>Tel：+86 0755 26008787",point:"114.117138|22.549122",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
         ];
    //创建marker
    function addMarker(){
